...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/3ject/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/3ject/VapeV4ForRoblox/main/assetsversion.dat",
		Method = "GET"
	})
